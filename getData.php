...
{
 $query .= '
 AND (Action LIKE "%'.$_POST["search"]["value"].'%" 
 OR Itemnumber LIKE "%'.$_POST["search"]["value"].'%" 
 OR Title LIKE "%'.$_POST["search"]["value"].'%"
 OR Listingsite LIKE "%'.$_POST["search"]["value"].'%"
 OR Currency LIKE "%'.$_POST["search"]["value"].'%"
 OR Startprice LIKE "%'.$_POST["search"]["value"].'%"
 OR BuyItNowprice LIKE "%'.$_POST["search"]["value"].'%"
 OR Relationship LIKE "%'.$_POST["search"]["value"].'%"
 OR Relationshipdetails LIKE "%'.$_POST["search"]["value"].'%"
 OR Customlabel LIKE "%'.$_POST["search"]["value"].'%"
